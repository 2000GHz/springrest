        ...
        stage('Login') {
            steps{
                ...
                withCredentials([string(credentialsId: 'Token-GitHub', variable: 'GITHUB_TOKEN')]) {
                    ...
                    sh 'docker-compose push ghcr.io/2000ghz/hello-springrest:1.0.${BUILD_NUMBER}' // Push image with tag 1.0.BuildNumber
                    sh 'docker-compose push ghcr.io/2000ghz/hello-springrest:latest' // Push image with tag latest
                }
            }
        }
    }
